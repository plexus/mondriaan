(defproject mondriaan "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "mondriaan.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main mondriaan.server
  ...
  :cljsbuild {:builds
              {:app
               {:source-paths ["src/cljs"]
                ...
                ;; :figwheel {:on-jsload "mondriaan.core/on-figwheel-reload"}

                :compiler {:main mondriaan.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/mondriaan.js"
